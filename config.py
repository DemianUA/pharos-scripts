# RPC endpoint
RPC = "https://testnet.dplabs-internal.com" #це не змінюйте, хіба що колись поміняють розробники
...
DELAY_BETWEEN_WALLETS = (100, 200)         # Затримка між обробкою різних гаманців
RANDOMIZE_WALLETS_ORDER = True         # Обробляти гаманці підряд чи випадково, True - рандомно, False - підряд


# Всі параметри для функції All In, рандомна кількість повторів однієї дії від-до. checkin True/False - робити/ні
ALL_IN_SETTINGS = {
